...
const TableRenderer = (options = {}) => {
  ...
  classColorMap.set("WARR",`rgb(198,155,109)`);
  classColorMap.set("PALA",`rgb(244,140,186)`);
  classColorMap.set("HUNT",`rgb(170,211,114)`);
  classColorMap.set("ROG",`rgb(255,244,104)`);
  ...
  const getTableHeight = (title, columns, dataSource) => {
    ...
    const headerHeight = (columns === null || columns === void 0 ? void 0 : columns.length) > 0 ? cellHeight : 0;
